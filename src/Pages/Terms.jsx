...
const Terms = () => {
  return (
    <div style={{padding:"5em"}}>
        <h3 style={{fontWeight:"bolder"}}>Terms & Conditions</h3>
        <p>
...
regulations, privacy policy and Terms of Use for access or usage of domain name thelearnex.com
('Website'), including the related mobile site and mobile application (hereinafter referred to as 
'Platform'). </p>
<p>
3. The Platform is owned by LEARNEX, a company incorporated under the Companies Act, 1956 
with its registered office at KURIE KOTTE HOUSE, PALLISSERY ROAD, 
PALARIVATTOM ,Ernakulam ,India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 
'our')..
</p> <p>
...
1. The use of Platform and/or availing of our Services is subject to the following Terms of Use:
...
delayed by a force majeure event.. </p>
<p> 
...
jurisdiction of the courts in Ernakulam and Kerala.</p>
<p>
14. 
All concerns or communications relating to these Terms must be communicated to us using 
the contact information provided on this websit
        </p>

        <h3 style={{fontWeight:"bolder"}}>Privacy Policy</h3>
        <p style={{fontWeight:"800"}}>Introduction</p>
        <p>
        This Privacy Policy describes how LEARNEX and its affiliates (collectively "LEARNEX, we, our, us") 
collect, use, share, protect or otherwise process your information/ personal data through our website 
thelearnex.com (hereinafter referred to as Platform). Please note that you may be able to browse certain 
...
any information. If you receive an email, a call from a person/association claiming to be LEARNEX
...
laws.
        ...
        <p>Insert Name of the Office:</p><br />
        <p>Designation</p><br />
        <p>Insert Name and Address of the Company:</p><br /> */}
        <p>Contact us: info@thelearnex.com   </p><br />
        <p>Phone: Time: Monday - Friday(9:00 - 18:00)</p><br /><br />

        <h3 style={{fontWeight:"bolder"}}>Refund and Cancellation policy</h3>
...
Cancellations will only be considered if the request is made 5 days of placing the order. However, 
...
LEARNEX does not accept cancellation requests for perishable items like flowers, eatables, etc. 
...
determined the same at its own end. This should be reported within 5 days of receipt of products. 
In case you feel that the product received is not as shown on the site or as per your expectations, 
you must bring it to the notice of our customer service within 5 days of receiving the product. The 
...
In case of any refunds approved by LEARNEX, it will take 10 days for the refund to be processed 
to you</p>
    </div>
  )
}
